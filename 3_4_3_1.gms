...
* using EMP framework.
*
*  Example from Section 3.4.3.1 - Gen. Nash Model for Coal Market -- Limit on Coal Yard, with Government Allocation of Coal Yard Shares
*  Results map to Table 3.4.
*
* -----------------------------------------------------------------------
...
* -----------------------------------------------------------------------
* Add in new constraint... (Eq. 3.37)
* -----------------------------------------------------------------------

EQUATION coalShare(i);
...
* -----------------------------------------------------------------------
* The contents of this new empinfo file look like this:
* -----------------------------------------------------------------------
* equilibrium
* min obj('i1') x('i1','b1') x('i1','b2') objdef_cournot('i1') coalShare('i1')
* min obj('i2') x('i2','b1') x('i2','b2') objdef_cournot('i2') coalShare('i2')
* min obj('i3') x('i3','b1') x('i3','b2') objdef_cournot('i3') coalShare('i3')
* vi demand q
* -----------------------------------------------------------------------


MODEL newCournot / objdef_cournot, coalShare, demand/;
