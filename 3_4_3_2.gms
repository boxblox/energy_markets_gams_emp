...
* using EMP framework.
*
*  Example from Section 3.4.3.2 - Gen. Nash Model for Coal Market -- Limit on Coal Yard, with Trading of Shares and Equal Marginal Utilities of Yard Shares
...
objdef_cournot2(i)..
    obj(i)
	=E=
    sum(b, C(i,b)*x(i,b) - (alpha - beta*sum((ii,bb), x(ii,bb)))*x(i,b)) - phi*(share(i) - sum(b, x(i,b)));
